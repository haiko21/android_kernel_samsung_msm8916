...
PROJECT_NAME="MuhKernel"		# please-enter-without-space.

PROJECT_VERSION="Test"	# please-enter-without-space. 
					# If the above two left as such, it will display "Flashing project-name v. project-version"

COPYRIGHT="copyright muhviehstarr"			# If left as such, it will display "(c) copyright"
